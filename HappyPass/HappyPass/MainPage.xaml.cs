...
namespace HappyPass
{
    public partial class MainPage : ContentPage
    {
        public MainPage()
        {
            ...
            NumberImg.GestureRecognizers.Add(new TapGestureRecognizer((view) => OnNumberImgClicked()));
            QrImg.GestureRecognizers.Add(new TapGestureRecognizer((view) => OnNumberImgClicked()));
        }
